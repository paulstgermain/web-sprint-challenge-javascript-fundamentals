...
// Because functions are capable of looking outside themselves for context: ie. when looking to see what the value of a given variable is, or to run functions outside of themselves. This is the concept of closure.
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(arr){
    let result = [];
    arr.forEach(item => result.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`));
    return result;
  }
